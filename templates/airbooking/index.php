...
<div class="art-layout-cell art-sidebar1<?php echo $view->containsModules('position-6', 'position-8', 'position-3') ? '' : ' art-sidebar1-fix';?>">
        ...
        <div class="art-footer-center">
            <div class="art-footer-wrapper">
                <div class="art-footer-text">
                    ...
                    <?php else: ?>
                    <?php ob_start(); ?>
<p style="text-align: left;">Copyright © 2011. All Rights Reserved. &nbsp;| Read more on <a href="#">Terms &amp; Conditions</a>.&nbsp;</p>

<p><br /></p>
<div class="cleared"></div>
<p class="art-page-footer">Template by <a href="http://joomla-mart.com" target="_blank">Joomla Mart</a>.</p>
